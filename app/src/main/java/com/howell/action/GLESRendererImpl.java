...
import com.gles.helper.gles.IGLESRenderer;
...
//    private final static String TAG = "VideoStreamsView";
    ...
    private GLESTextureView gl_texture_view_;
...
//		}
    ...
    public GLESRendererImpl(Context context, GLESTextureView view, Handler handler) {

        context_ = context;
        gl_texture_view_ = view;
