...
public class BrokenView extends View {
    ...
    public BrokenAnimator createAnimator(final View view,Point point,BrokenConfig config){
      ...
      //  Log.i("123","createAnimator addlistneer");
        bAnim.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationRepeat(Animator animation) {
                super.onAnimationRepeat(animation);
                //Log.i("123","onAnimationRepeat");
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                }else if(bAnim.getStage()==BrokenAnimator.STAGE_EARLYEND){
                    onBrokenFinish(view);
                }
            }
        });
    ...
    protected void onBrokenFinish(View v){
        if (callBack!=null){
            callBack.onFinish(v);
        }
    }
