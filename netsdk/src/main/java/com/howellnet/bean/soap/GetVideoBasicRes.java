...
public class GetVideoBasicRes {
    ...
    public GetVideoBasicRes(String result, String DNMode, DNSensitivity dnSensitivity, String AGCMode, AGC agc, String eShutterMode, EShutter eShutter, String infraredMode) {
