...
public class GetVMDParamRes {
    ...
    public GetVMDParamRes() {
    }

    public GetVMDParamRes(String result, Boolean enable, int sensitivity, int startTriggerTime, int endTriggerTime, int rowGranularity, int columnGranularity, VMDGrid vmdGrid, WorkSheet workSheet) {
