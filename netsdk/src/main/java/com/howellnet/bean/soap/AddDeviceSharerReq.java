...
public class AddDeviceSharerReq {
    ...
    public AddDeviceSharerReq() {
    }

    public AddDeviceSharerReq(String account, String session, String devID, int channelNo, String sharerAccount, int sharingPriority, String sharingName) {
