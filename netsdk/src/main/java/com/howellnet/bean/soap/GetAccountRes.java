...
public class GetAccountRes {
    ...
    public GetAccountRes() {
    }

    public GetAccountRes(String result, String userName, String email, String mobileTel, String country, String countryTelCode, String IDCard) {
