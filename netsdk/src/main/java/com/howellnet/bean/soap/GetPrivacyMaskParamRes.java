...
public class GetPrivacyMaskParamRes {
    String result;
    Boolean enable;
    ...
    public GetPrivacyMaskParamRes() {
    }

    public GetPrivacyMaskParamRes(String result, Boolean enable, int horizontalResolution, int verticalResolution, PrivacyMaskRegion privacyMaskRegion) {
