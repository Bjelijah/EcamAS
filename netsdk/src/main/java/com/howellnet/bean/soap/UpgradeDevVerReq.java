...
public class UpgradeDevVerReq {
    ...
    public UpgradeDevVerReq(String account, String session, String devID, String newDevVer, String ftpAddress, int ftpPort, String ftpAccount, String ftpPassword, String ftpFileName) {
