...
public class QueryDeviceStatusRes {
    String result;
    int pageNo;
    int pageCount;
    int recordCount;
    ...
    public QueryDeviceStatusRes() {
    }

    public QueryDeviceStatusRes(String result, ArrayList<NodeList> nodeLists, WirelessNetwork wirelessNetwork) {
    ...
    public static class NodeList{
        ...
        public NodeList(String devID, int channelNo, String name, Boolean onLine, Boolean ptzFlag, int securityArea, int eStoreFlag, String upnpIP, int upnpPort, String devVer, int curVideoNum, String lastUpdated, int smsSubscribedFlag, int emailSubscribedFlag, int sharingFlag, int applePushSubscribedFlag, int androidPushSubscribedFlag, int infraredFlag, int wirelessFlag) {
