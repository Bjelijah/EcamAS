...
public class GetOSDParamRes {
    ...
    public GetOSDParamRes(String result, Boolean enable, Boolean timestampEnabled, String dateTimeFormat, String displayText, int fontSize, int fontColor, int textPositionX, int textPositionY, int timestampPositionX, int timestampPositionY) {
