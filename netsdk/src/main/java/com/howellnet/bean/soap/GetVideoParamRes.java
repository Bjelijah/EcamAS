...
public class GetVideoParamRes {
    ...
    public GetVideoParamRes() {
    }

    public GetVideoParamRes(String result, String videoStandard, int rotationDegree, int brightness, int contrast, int saturation, int hue, Boolean infrared) {
