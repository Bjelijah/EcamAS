...
public class SetPrivacyMaskParamReq {
    String account;
    String session;
    String devID;
    int channelNo;
    ...
    public SetPrivacyMaskParamReq() {
    }

    public SetPrivacyMaskParamReq(String account, String session, String devID, int channelNo, Boolean enable, PrivacyMaskRegion privacyMaskRegion) {
